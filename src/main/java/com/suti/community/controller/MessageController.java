...
import com.suti.community.entity.Message;
...
public class MessageController implements CommunityConstant {
    ...
    public String getNoticeList(Model model) {
        ...
        // 查询评论类通知
        Message messageComment = messageService.findLatestNotice(user.getId(), TOPIC_COMMENT);
        Map<String, Object> commentNotice = new HashMap<>();
        commentNotice.put("message", messageComment);
        if (messageComment != null) {
            String content = HtmlUtils.htmlUnescape(messageComment.getContent());
            Map<String, Object> data = JSONObject.parseObject(content, HashMap.class);

            commentNotice.put("user", userService.findUserById((Integer) data.get("userId")));
        ...
        followNotice.put("message", messageFollow);
        ...
        if (messageFollow != null) {
            ...
            followNotice.put("user", userService.findUserById((Integer) data.get("userId")));
            ...
            followNotice.put("unread", unread);
        }
